...
**Taskbar Media Player —** is a Windhawk mod that integrates a modern media player with Fluent Design directly into the Windows 11 taskbar. It allows you to control music and view track information seamlessly without interrupting your workflow.
...
3. Enter **Taskbar Media Player** in the search field.
4. In the results, select [Taskbar Media Player](https://windhawk.net/mods/taskbar-media-player).
...
recode:  [@Eliasilyz](https://github.com/Eliasilyz)
